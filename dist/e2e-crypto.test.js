...
async function browserDecrypt(payload, keyBase64) {
    ...
    const decryptedBuffer = await webcrypto.subtle.decrypt({ name: 'AES-GCM', iv: ivBuffer }, cryptoKey, combinedBuffer);
...
//# sourceMappingURL=e2e-crypto.test.js.map